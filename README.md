...
NeoObjects is a Blender addon which provides additional objects that are useful for modeling BallisticNG track scenery.

Right now this is just a TRM edge object.
...
## Developing
NeoObjects is written in Pycharm Community Edition and contains a build script / run configuration for automatic addon installation, allowing the project to sit separately to a live Blender installation.
